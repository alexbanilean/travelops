			...
			<section className="relative overflow-hidden bg-gradient-to-br from-primary/12 via-background to-accent/20 pb-28 pt-16 sm:pt-20">
				...
				<div className="container-app relative text-center">
					...
					<p className="mx-auto mb-10 max-w-3xl text-lg leading-relaxed text-muted-foreground md:text-xl md:leading-relaxed">
						TravelOps is the command center for corporate travel —
						combining AI-powered planning, booking, and expense
						tracking into one streamlined system. Reduce planning
					...
					<div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
						...
						<Link href="/dashboard" className="cursor-pointer">
							<Button
								size="lg"
								variant="outline"
								className="h-14 cursor-pointer px-8 text-lg transition-colors duration-200"
							>
								View demo
							</Button>
						</Link>
					...
					<div className="mx-auto mt-16 grid max-w-lg grid-cols-3 gap-8">
						{[
							...
							{
								value: "€1.4T",
								label: "Global corp. travel market",
							},
				...
				<div className="container-app">
					<div className="mb-16 text-center">
						...
						<p className="mx-auto max-w-2xl text-lg text-muted-foreground md:text-xl">
							Two specialized AI agents work in concert to handle
							planning logistics and financial tracking —
							automatically.
						</p>
					</div>
					...
					<div className="mb-16 grid gap-8 md:grid-cols-2">
						...
						<Card className="border-2 border-primary/20 bg-gradient-to-br from-primary/8 to-card shadow-sm transition-shadow duration-200 hover:shadow-md">
							<CardContent className="p-8">
								...
								<p className="mb-6 leading-relaxed text-muted-foreground">
									Your AI travel concierge. Give it a
									destination, dates, headcount and budget —
									it searches flights, hotels, activities and
									restaurants, then builds a complete
						...
						<Card className="border-2 border-emerald-500/25 bg-gradient-to-br from-emerald-500/10 to-card shadow-sm transition-shadow duration-200 hover:shadow-md dark:border-emerald-400/30">
							<CardContent className="p-8">
								...
								<p className="mb-6 leading-relaxed text-muted-foreground">
									Your AI finance controller. It tracks
									budgets in real time, processes uploaded
									invoices via OCR, flags overspending risks,
									and keeps every euro accounted for.
								</p>
								<div className="grid grid-cols-2 gap-3">
									{[
										{
							...
							({ icon: Icon, title, description, color, bg }) => (
								...
								>
									<CardContent className="p-6">
										<div
											className={`mb-4 flex size-10 items-center justify-center rounded-lg ${bg}`}
										>
											<Icon
			...
			<section id="how-it-works" className="bg-muted/50 py-24">
				<div className="container-app">
					<div className="mb-16 text-center">
						...
						<p className="mx-auto max-w-2xl text-lg text-muted-foreground md:text-xl">
							TravelOps makes corporate event planning effortless
							for HR teams of any size.
						</p>
					</div>
					...
					<div className="relative grid gap-8 md:grid-cols-3">
						...
						{[
							...
							({
								...
								>
									<div
										className={`w-14 h-14 rounded-2xl ${color} flex items-center justify-center mx-auto mb-6 shadow-lg`}
									>
				...
				<div className="container-app max-w-5xl">
					<div className="mb-12 text-center">
						...
						<p className="text-muted-foreground">
							A real example: 20 people, 2 days in Prague, €8,000
							budget
						</p>
					</div>
					<Card className="overflow-hidden border-2 border-border shadow-lg">
						<div className="flex items-center gap-2 bg-foreground px-4 py-3">
							<div
								className="size-3 shrink-0 rounded-full bg-red-500"
								aria-hidden
							/>
							<div
								className="size-3 shrink-0 rounded-full bg-amber-400"
								aria-hidden
							/>
							<div
								...
								<div className="flex items-start gap-3">
									...
									<div className="max-w-md rounded-2xl rounded-tl-sm bg-muted px-4 py-3">
										<p className="text-sm text-foreground">
											Plan a 2-day team building in Prague
											for 20 people with €8,000.
										</p>
									</div>
								</div>
									...
									<div className="max-w-lg space-y-2">
										...
										<div className="rounded-2xl rounded-tr-sm bg-primary px-4 py-3 text-primary-foreground shadow-md">
											...
											<div className="space-y-2 text-xs text-primary-foreground/90">
												...
												<p>
													Flights BUH→PRG — Czech
													Airlines OK710 · €2,700
												</p>
												<p>
			...
			<section className="bg-muted/50 py-24">
				<div className="container-app max-w-5xl">
					...
					<div className="grid gap-6 md:grid-cols-2">
						{[
							{
								quote: "TravelOps cut our quarterly offsite planning from 3 days to under an hour. The Finance Agent's budget tracking alone saved us from a €4,000 overrun on our last company retreat.",
							...
							{
								quote: "We manage 200+ business trips per year. TravelOps replaced four separate tools and our finance team finally has real-time visibility. The invoice OCR is a game-changer.",
			...
			>
				<div className="container-app max-w-4xl text-center">
					...
					<p className="mx-auto mb-10 max-w-2xl text-lg text-white/90">
						...
						Two AI agents ready to plan your next corporate event in
						minutes.
					</p>
					...
					<div className="flex flex-col justify-center gap-4 sm:flex-row">
						<Link
							href="https://docs.google.com/document/d/1-U2oY3vzIODeQtJNxSOn2eH7mJrlOfIu9gW1nqFXxAU/edit?usp=sharing"
							className="cursor-pointer"
						>
							<Button
								size="lg"
						...
						<Link
							href="https://www.canva.com/design/DAHJQuVrCYk/4c9oQZQ1zg7M6SbUYrdXcQ/view"
							className="cursor-pointer"
						>
							<Button
								size="lg"
						...
						<Link
							href="https://github.com/alexbanilean/travelops"
							className="cursor-pointer"
						>
							<Button
								size="lg"
					...
					<div className="mt-16 overflow-x-auto">
						<table className="mx-auto w-full max-w-2xl text-left text-sm">
							<thead>
			...
			<footer className="border-t border-border bg-foreground py-12 text-background">
				<div className="container-app">
					...
					<p className="text-center text-xs text-background/60">
						© 2026 TravelOps. Planning + Finance agents via Google
						Gemini.
					</p>
				</div>
			</footer>
